...
public class ExecuteTest_pause extends Thread {
    ...
    public ExecuteTest_pause(String NAME_COLLECTION, List<String> sites, String task_id, Map<String, Thread> map, List<String> test) {
